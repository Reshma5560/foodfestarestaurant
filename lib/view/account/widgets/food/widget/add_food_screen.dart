                                ...
                                children: [
                                  ...
                                  AppTextField(
                                    enabledBorder: OutlineInputBorder(
                                        borderRadius: BorderRadius.circular(defaultRadius), borderSide: BorderSide(color: AppColors.white)),
                                  ...
                                  AppButton(
                                      ...
                                      onPressed: () {
                                        if (con.isEdit.isFalse) {
                                          if (con.foodNameCon.value.text.isEmpty) {
                                            con.foodNameError.value = "Please enter food name";
                                            con.foodNameValidation.value = true;
                                          } else {
                                            con.foodNameError.value = "";
                                            con.foodNameValidation.value = false;
                                          }

                                          if (con.foodNameValidation.isFalse) {
