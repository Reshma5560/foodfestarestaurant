...
class BusinessManagementScreen extends StatelessWidget {
  ...
  final BusinessManagementController con = Get.put(BusinessManagementController());
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: AppButton(
                                        ...
                                        width: Get.width / 2,
                                        onPressed: () {
                                          Get.toNamed(AppRoutes.businessManagementScheduleScreen);
                                        },
                                        child: Text(
                                          "Next",
            ...
            ? Wrap(
                ...
                return con.selectedChoice.contains(e.id)
                    ? Container(
                        ...
                        child: Text(
                          e.cuisineName ?? "",
                          style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.w600, color: Theme.of(Get.context!).primaryColor),
                        ),
                      )
                    : const SizedBox();
              }).toList())
      ...
      choices.add(
        Container(
          ...
          child: ChoiceChip(
            ...
            //  == item.id,
            onSelected: (selected) {
              con.selectedChoice.contains(item.id) ? con.selectedChoice.remove(item.id) : con.selectedChoice.add(item.id ?? "");
            },
          ),
        ),
      );
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: AppColors.greyFontColor, fontWeight: FontWeight.w600, fontSize: 9),
                          )
                        ],
                      ),
                    )),
