      ...
      InterceptorsWrapper(
        ...
        onError: (DioException e, handler) {
          try {
            ...
            printError(errText: "$e", type: "CreateErrorEntity function");
          }
  ...
  Future apiErrorHandler(int statusCode, {bool isLogin = false}) async {
    try {
      if (statusCode == 400) {
        ...
        // await getx.Get.find<FirebaseController>().logoutAll();
      } else if (statusCode == 403) {
        // await getx.Get.find<FirebaseController>().logoutAll(isLogin: isLogin);
      }
    } catch (e, stackTrace) {
