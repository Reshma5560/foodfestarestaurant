...
//
//      getCustomerModel = getCustomerModelFromJson(jsonString);
...
class GetCustomerModel {
  ...
  factory GetCustomerModel.fromJson(Map<String, dynamic> json) =>
      GetCustomerModel(
        ...
        data: json["data"] == null
            ? []
            : List<GetCustomerDatum>.from(
                json["data"]!.map((x) => GetCustomerDatum.fromJson(x))),
      );
...
class GetCustomerDatum {
  ...
  factory GetCustomerDatum.fromJson(Map<String, dynamic> json) =>
      GetCustomerDatum(
        id: json["id"],
