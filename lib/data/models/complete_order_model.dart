...
CompleteOrderModel completeOrderModelFromJson(String str) => CompleteOrderModel.fromJson(json.decode(str));

String completeOrderModelToJson(CompleteOrderModel data) => json.encode(data.toJson());
...
class CompleteOrderModel {
    ...
    factory CompleteOrderModel.fromJson(Map<String, dynamic> json) => CompleteOrderModel(
        status: json["status"],
        data: json["data"] == null ? null : CompleteOrderData.fromJson(json["data"]),
    );
...
class CompleteOrderData {
    ...
    final List<CompleteOrderDatum>? data;
    ...
    factory CompleteOrderData.fromJson(Map<String, dynamic> json) => CompleteOrderData(
        currentPage: json["current_page"],
        data: json["data"] == null ? [] : List<CompleteOrderDatum>.from(json["data"]!.map((x) => CompleteOrderDatum.fromJson(x))),
...
class CompleteOrderDatum {
    ...
    factory CompleteOrderDatum.fromJson(Map<String, dynamic> json) => CompleteOrderDatum(
        id: json["id"],
