...
class CustomEarningContainer extends StatelessWidget {
  ...
  const CustomEarningContainer({super.key, required this.title, required this.subTitle, required this.image});
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  subTitle,
                  style: TextStyle(fontSize: 10.sp, color: AppColors.black, fontWeight: FontWeight.w600),
                )
              ],
            ),
            Image.asset(
